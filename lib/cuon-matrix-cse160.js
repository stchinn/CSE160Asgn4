...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        let d = other1.elements[0] * other2.elements[0] + other1.elements[1] * 
        other2.elements[1] + other1.elements[2] * other2.elements[2]; // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        let v3x = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        let v3y = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        let v3z = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
        let v3 = new Vector3([v3x, v3y, v3z]); // Modify this line to calculate cross product between other1 and other2.
